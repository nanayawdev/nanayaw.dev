...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-riptide-400 text-neutral-50 shadow hover:bg-riptide-700 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/80",
        secondary:
        ...
        outline: "text-neutral-900 dark:text-neutral-50 border-neutral-900 dark:border-neutral-50",
      },
    },
    defaultVariants: {
      variant: "default",
