import { LayoutGrid, User, FolderKanban, BookOpenText, Mail, BriefcaseBusiness, FileText, Circle, Star } from 'lucide-react';
...
export const navigationConfig = [
  ...
  { path: '/blog', label: 'Blog', icon: <BookOpenText className="w-5 h-5" />, component: Blog },
